...
| AV_STATUS_SNS_ARN | SNS topic ARN to publish scan results. Note that your role will need SNS:Publish actions against your SNS Topic. (optional) | | No |
| AV_STATUS_SNS_NOTIFY_CLEAN | Send SNS notifications for clean files (optional) | | No |
